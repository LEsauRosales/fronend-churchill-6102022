...
getAllGeofencings(map: any){
  ...
  this.chFleetApiService.getAllRouteDeviation().subscribe((data)=>{
      ...
      for (let key of Object.keys(this.geofencingsDetails)) {
         ...
         console.log(coords.ilsp_mt_route_deviation_geocoords);
         coords.ilsp_mt_route_deviation_geocoords.forEach(element => {
    ...
    if(this.formGeofencingRegister.valid){
        ...
        if(this.drawerGeofencingCoords != null ){
          ...
          // initialized array coords
           this.geofencingRegister.ilsp_mt_route_deviation_geocoords = [];
              ...
              this.geofencingRegister.ilsp_mt_route_deviation_geocoords.push({latitude: coords.lat, longitude : coords.lng});
              }

              console.log(this.geofencingRegister);
              this.chFleetApiService.postNewRouteDeviation(this.geofencingRegister)
          .subscribe(data=>{
            console.log(data);
          })
...
deleteGeofencingCoords(){
    ...
    this.chFleetApiService.deleteRouteDeviation(this.selectedDeleteGeo.id)
    .subscribe(data=>{
      console.log(data);
    });
