...
getAllGeofencings(map: any){
  ...
  this.chFleetApiService.getAllAuthorizedStop().subscribe((data)=>{
      ...
      for (let key of Object.keys(this.geofencingsDetails)) {
         ...
         console.log(coords.ilsp_mt_authorized_stop_geocoords);
         coords.ilsp_mt_authorized_stop_geocoords.forEach(element => {
    ...
    if(this.formGeofencingRegister.valid){
        ...
        if(this.drawerGeofencingCoords != null ){
          ...
          // initialized array coords
           this.geofencingRegister.ilsp_mt_authorized_stop_geocoords = [];
              ...
              this.geofencingRegister.ilsp_mt_authorized_stop_geocoords.push({latitude: coords.lat, longitude : coords.lng});
              }

              console.log(this.geofencingRegister);
              this.chFleetApiService.postNewAuthorizedStop(this.geofencingRegister)
          .subscribe(data=>{
            console.log(data);
          })
...
deleteGeofencingCoords(){
    ...
    this.chFleetApiService.deleteAuthorizedStop(this.selectedDeleteGeo.id)
    .subscribe(data=>{
      console.log(data);
    });
